			...
			<center>
				<table  border="1" cellpadding="0" cellspacing="0" width="25%">
					...
					<tr height="40px">
						...
						<td>
						<input type="text" name="member_zipcode" class="postcodify_postcode5" value="1234" readonly/>
					...
					<tr height="40px">
						...
						<td>
							<input type="text" name="member_address" class="postcodify_address" value="sdfdf" style="width:280px;" readonly/><br />
						</td>
					</tr>
					<tr height="40px">
						<td align="center" width="100px">상세주소</td>
						<td>
							<input type="text" name="member_address_detail" class="postcodify_details" value="sdfdf" style="width:280px;" /><br />
						</td>
					</tr>
					<tr height="40px">
						<td align="center" width="100px">참고항목</td>
						<td>
							<input type="text" name="member_address_etc" class="postcodify_extra_info" value="sdfdf" style="width:280px;" readonly /><br />
						</td>
					</tr>
					<tr height="40px">
						<td colspan="2" align="center">
