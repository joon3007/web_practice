...
<body>
	<% 
		...
		int result = m_dao.join(m_vo.getId(), m_vo.getName(),m_vo.getPw(),m_vo.getGender(),m_vo.getZip_code(),
				m_vo.getAddress(),m_vo.getAddress_detail(), m_vo.getAddress_etc(),m_vo.getHp(),m_vo.getHobby());
